        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
            <form onSubmit={onSubmit}>
                ...
                <div className='flex justify-between whiteespace-nowrap text-sm sm:text-lg'>
                  <p className='mb-6'>Dont have account?
                   <Link to='/sing-up' className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1'>Register</Link>
                  </p>
                  <p>
                  <Link to='/sing-in' className='text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out'>sing in</Link>
                  </p>
                </div>
